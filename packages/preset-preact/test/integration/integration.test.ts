...
describe('With preserved', () => {
  ...
  it('Should return 200 response - /', async () => {
    ...
    expect(await res.text()).toBe(
      '<!doctype html><html><head><script type="module" src="./test/app/client.ts"></script><title>This is a title</title><meta name="description" content="This is a description"/></head><body><h1>Hello</h1></body></html>'
    )
  })
  ...
  it('Should return 404 response - /foo', async () => {
    ...
    expect(res.status).toBe(404)
    expect(await res.text()).toBe(
      '<!doctype html><html><head><script type="module" src="./test/app/client.ts"></script></head><body><h1>Not Found</h1></body></html>'
    )
  })
  ...
  it('Should return 200 response /about/me', async () => {
    ...
    expect(res.status).toBe(200)
    expect(await res.text()).toBe(
      `<!doctype html><html><head><script type="module" src="./test/app/client.ts"></script><title>me</title></head><body><main><p>It's me</p><b>My name is me</b></main></body></html>`
    )
  })
  ...
  it('Should return 500 response /throw_error', async () => {
    ...
    expect(res.status).toBe(500)
    expect(await res.text()).toBe(
      `<!doctype html><html><head><script type="module" src="./test/app/client.ts"></script></head><body><h1>Custom Error Message: Foo</h1></body></html>`
    )
  })
})
...
describe('With islands', () => {
  ...
  it('Should return 200 response - /with_island', async () => {
    ...
    expect(res.status).toBe(200)
    expect(await res.text()).toBe(
      `<p><div component-name="Counter.tsx" data-serialized-props="{&quot;initial&quot;:10}"><p>Count: 10</p><button>Increment</button></div></p>`
    )
  })
})
...
describe('MDX', () => {
  ...
  it('Should return 200 response with MDX', async () => {
    ...
    expect(res.status).toBe(200)
    expect(await res.text()).toBe(
      '<!doctype html><html><head><script type="module" src="./test/app/client.ts"></script></head><body><h2>Hello MDX!</h2></body></html>'
    )
  })
})
